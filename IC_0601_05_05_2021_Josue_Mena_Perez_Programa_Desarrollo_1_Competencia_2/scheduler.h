...
//Declaraciòn de procesos
pthread_t Proceso1,Proceso2,Proceso3,Proceso4,Proceso5,Proceso6,Proceso7,Proceso8;

//Variable para estructura repetitiva
int i;

//Declaraciòn de puntero a variables carácter
char *Accion;
